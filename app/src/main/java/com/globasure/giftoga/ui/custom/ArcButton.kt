...
/**
 * Created by longnguyen on 7:29 AM, 4/2/20.
 *
 */
class ArcButton(context: Context?) : MaterialButton(
    ...
    private fun updateIcon() {
        if (this.icon != null) {
            ...
            val width = if (this.iconSize != 0) this.iconSize else this.icon!!.intrinsicWidth
            val height = if (this.iconSize != 0) this.iconSize else this.icon!!.intrinsicHeight
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        val iconWidth = if (this.iconSize != 0) this.iconSize else this.icon!!.intrinsicWidth
